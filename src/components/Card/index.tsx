...
export const Card = ({
  ...
  return (
    <a href={linkHref} download={webProperty === 'press'} target={target} className={`rounded-xl inline-block w-full flex ${webProperty === 'ousd' ? 'transition duration-300 border-[#00000080] shadow-black hover:drop-shadow-2xl hover:border-[#00000000] border-[1px] bg-gradient-to-r from-[#8c66fc] to-[#0274f1]' : ''}`}>
      <div className={`rounded-[0.65rem] inline-block w-full shadow overflow-hidden flex flex-col ${webProperty === 'ousd' ? 'bg-[#1e1f25] text-[#fafbfb]' : 'text-black'}`}>
