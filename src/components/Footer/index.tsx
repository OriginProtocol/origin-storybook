...
export const Footer = () => (
  <div className="w-full bg-gradient-to-r from-black to-footer-end py-10 md:py-20 text-white">
    <div
      className="border-b flex flex-col md:flex-row space-y-12 md:space-y-0 pb-12 md:pb-7 px-9 max-w-screen-xl mx-auto"
    ...
    >
      ...
      <div className="flex flex-col flex-2 space-y-4">
        <Typography.Body2 className="font-bold">Organization</Typography.Body2>
      ...
      <div className="flex flex-col flex-2 space-y-4">
        <Typography.Body2 className="font-bold">Products</Typography.Body2>
      ...
      <div className="flex flex-col flex-2 space-y-4">
        <Typography.Body2 className="font-bold">Resources</Typography.Body2>
        <div className="flex flex-row md:flex-col space-x-4 md:space-x-0 md:space-y-4 opacity-75">
    ...
    <div className="pt-10 flex flex-col md:flex-row space-y-2 md:space-y-0 justify-between opacity-75 px-9 max-w-screen-xl mx-auto">
      ...
      <div className="flex space-x-6">
        <Typography.Body2 href="/privacy">Privacy Policy</Typography.Body2>
        <Typography.Body2 href="/tos">Terms of Service</Typography.Body2>
      </div>
    </div>
  </div>
);
