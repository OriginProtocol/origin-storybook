...
export const Header = ({ webProperty, mappedLinks, active, language }: HeaderProps) => {
  ...
  return (
    <header className={`${webProperty === 'ousd' ? 'px-8 md:px-16 lg:px-[134px]' : ''}`}>
      <div className={`py-9 md:py-16 w-full flex justify-between items-center mx-auto ${webProperty === 'ousd' ? 'max-w-[1432px]' : 'max-w-screen-xl px-9'}`}>
